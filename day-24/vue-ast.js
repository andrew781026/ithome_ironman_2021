const factoryFn = (global, factory) => global.Parse = factory();

const myParse = function () {
  ...
  const Parse = template => parse(template);
...
// if you are in browser please replace `process` with `window`
factoryFn(process, myParse);

const b = process.Parse(`
<div class="container">
